...
import { songs } from '../assets/assests2'; // Import the updated songs array

function Trending() {
  const [selectedSong, setSelectedSong] = useState(songs[0]); // Default to the first song
    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="h-[80%] min-h-[80vh] flex flex-col md:flex-row">
        ...
        <div className="flex-1 w-full px-4">
          <p className='text-white mt-2 text-lg'>Trending Songs</p>
